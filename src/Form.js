...
function Form(props) {
    ...
    const postBounty = (e) => {
        ...
        let preJSONBody = {
            ...
            caputured: Boolean(newBounty.caputured)
        }
    ...
    return(
        <form onSubmit={postBounty}>
            ...
            <div>
                <label htmlFor="caputured">Captured:</label>
                <input type="checkbox" name="caputured" id="caputured" onChange={handleCheck} checked={newBounty.caputured?"checked":""}/>
            </div>
